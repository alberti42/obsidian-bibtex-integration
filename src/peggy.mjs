...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(last, first) { 
    if(!first) {
  ...
  var peg$f8 = function(t) { return null; };
  ...
  function peg$parseauthor() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseauthor_name();
    if (s1 !== peg$FAILED) {
      s2 = peg$currPos;
      s3 = peg$parsefirst_last_sep();
      if (s3 !== peg$FAILED) {
        s4 = peg$parseauthor_name();
        if (s4 !== peg$FAILED) {
          s2 = s4;
        } else {
          peg$currPos = s2;
